...
Ship::Ship() : m_maxSpeed(1.0f)
{
	...
	m_currentHeading = -90.0f; // current facing angle
...
void Ship::draw()
{
	...
	// draw the ship
	TextureManager::Instance()->draw("ship", ScreenPosition.x, ScreenPosition.y, m_currentHeading, 255, true);
}
